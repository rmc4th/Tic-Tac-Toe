...
const Board = () => {
  ...
  let winnerCheck = checkForWinner(gameState);
  let status = `Winner is ${winnerCheck}`;
  let done = false;
  if (winnerCheck !== "No Winner Yet") {
	  done = true;
  }
  ...
  function renderSquare(i) {
    ...
    return <Square takeTurn={takeTurn} id={i} done={done}></Square>;
  }
  return (
